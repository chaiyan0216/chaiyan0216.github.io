...
- Mac 接好串口线（PLC2303）：`screen /dev/tty.usbserial-xxxx 115200`，板上接法见下图。
  ...
  [![img](/Users/cy/Downloads/github/chaiyan0216.github.io/images/beaglebone_black-a5c_serial-header.png)](https://openwrt.org/_detail/media/beaglebone/black/beaglebone_black-a5c_serial-header.png?id=toh%3Atexas_instruments%3Abeaglebone_black)
...
```shell
$ zcat openwrt-omap-ti_am335x-bone-black-ext4-sdcard.img.gz| dd of=/dev/mcblk1 bs=4k conv=fsync
```

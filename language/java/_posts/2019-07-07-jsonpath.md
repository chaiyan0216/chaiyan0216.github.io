...
| $.store.book[?(@.price < 10)]         | [价格小于 10 的全部书](https://jsonpath.herokuapp.com/?path=$.store.book[?(@.price < 10)]) |
| $..book[?(@.price <= $['expensive'])] | [价格小于 expensive 的全部书](https://jsonpath.herokuapp.com/?path=$..book[?(@.price <= $['expensive'])]) |
